...
* Shell access whilst the container is running: `docker exec -it grav /bin/bash`
...
* Update all images: `docker-compose pull`
  * or update a single image: `docker-compose pull grav`
* Let compose update all containers as necessary: `docker-compose up -d`
  * or update a single container: `docker-compose up -d grav`
* You can also remove the old dangling images: `docker image prune`

### Via Docker Run
* Update the image: `docker pull ghcr.io/linuxserver/grav`
* Stop the running container: `docker stop grav`
* Delete the container: `docker rm grav`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/linuxserver/grav:latest .
```
